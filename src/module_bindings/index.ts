...
import TilePublicRow from "./tile_public_table";
import TileSecretRow from "./tile_secret_table";
...
const tablesSchema = __schema({
  game_state: __table({
    ...
    indexes: [
      ...
      { name: 'game_state_lobby_id', algorithm: 'btree', columns: [
        'lobbyId',
      ] },
    ],
    constraints: [
  ...
  lobby_member: __table({
    ...
    indexes: [
      ...
      { name: 'lobby_member_player_identity', algorithm: 'btree', columns: [
        'playerIdentity',
      ] },
    ],
    constraints: [
  ...
  tile_public: __table({
    ...
    indexes: [
      ...
      { name: 'tile_public_lobby_id', algorithm: 'btree', columns: [
        'lobbyId',
      ] },
      { name: 'tile_public_owner', algorithm: 'btree', columns: [
        'ownerId',
      ] },
    ],
    constraints: [
      { name: 'tile_public_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, TilePublicRow),
  tile_secret: __table({
    name: 'tile_secret',
    indexes: [
      ...
      { name: 'tile_secret_owner', algorithm: 'btree', columns: [
        'ownerId',
      ] },
      { name: 'tilePublicId', algorithm: 'btree', columns: [
        'tilePublicId',
      ] },
    ],
    constraints: [
      { name: 'tile_secret_id_key', constraint: 'unique', columns: ['id'] },
      { name: 'tile_secret_tile_public_id_key', constraint: 'unique', columns: ['tilePublicId'] },
    ],
  }, TileSecretRow),
});
